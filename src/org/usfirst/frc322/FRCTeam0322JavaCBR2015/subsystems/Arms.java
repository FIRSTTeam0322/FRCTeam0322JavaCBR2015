...
public class Arms extends Subsystem {
    ...
    SpeedController leftArmRotator = RobotMap.armsLeftArmRotator;
    SpeedController rightArmRotator = RobotMap.armsRightArmRotator;
    SpeedController leftArmWheel = RobotMap.armsLeftArmWheel;
    SpeedController rightArmWheel = RobotMap.armsRightArmWheel;
    ...
    public void rightArmControl(double speed) {
    	rightArmRotator.set(speed);
    }
